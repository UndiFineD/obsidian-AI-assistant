...
def test_spec_template_exists():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        spec_path = change_path / "spec.md"
        custom_content = "# Custom Specification\n\nThis is custom content that should NOT be overwritten. " * 10
        ...
        assert updated_content == custom_content, "Existing spec.md should not be modified"
