"""
FastAPI Exception Handlers for Obsidian AI Assistant
...
async def obsidian_ai_exception_handler(request: Request, exc: ObsidianAIError) -> JSONResponse:
...
async def validation_exception_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
    ...
    response = ErrorResponse(
        error=error_detail,
        request_id=validation_error.request_id
    )
