...
class SecurityScanner:
    ...
    def scan_with_safety(self) -> Dict:
        ...
        print("🔒 Running Safety security scan...")
        ...
        try:
            ...
            try:
                # Run safety check
                cmd = [sys.executable, '-m', 'safety', 'check', '-r', tmp_path, '--json']
                ...
                if result.returncode == 0:
                    ...
                    try:
                        ...
                        # Parse text output
                        results['vulnerabilities'] = self._parse_safety_text(result.stdout)
                else:
    ...
    def scan_with_bandit(self) -> Dict:
        ...
        try:
            ...
            cmd = [
                sys.executable, '-m', 'bandit', '-r', str(backend_path),
    ...
    def check_outdated_packages(self) -> Dict:
        ...
        try:
            ...
            if result.returncode == 0 and result.stdout:
                ...
                security_packages = [
                    'cryptography', 'pyjwt', 'requests', 'urllib3', 'pillow',
                    'django', 'flask', 'fastapi', 'sqlalchemy', 'psycopg2',
                    'paramiko', 'pyopenssl', 'certifi', 'click', 'jinja2'
                ]
                ...
                for pkg in outdated_data:
                    pkg_info = {
                        ...
                        'is_security_sensitive': pkg['name'].lower() in security_packages
                    }
    ...
    def check_github_advisories(self) -> Dict:
        ...
        print("🔍 Checking GitHub security advisories...")
    ...
    def analyze_supply_chain_risk(self) -> Dict:
        ...
        print("🔗 Analyzing supply chain risks...")
            ...
            for dep_name in dependencies:
                ...
                if pkg_info:
                    ...
                    if pkg_info.get('last_updated'):
                        ...
                        days_since_update = (datetime.now().replace(tzinfo=None) - 
                                           last_update.replace(tzinfo=None)).days
                        ...
                        if days_since_update > 365:
                            ...
                            risk_score += 1
                            risk_factors.append(f"Last updated {days_since_update} days ago")
    ...
    def generate_security_report(self) -> Dict:
        ...
        for scan_name, scan_func in scans:
            try:
                ...
                print(f"❌ Error running {scan_name} scan: {e}")
    ...
    def save_security_report(self, report: Dict, output_file: Optional[Path] = None) -> None:
    ...
    def print_security_summary(self, report: Dict) -> None:
        ...
        if total_issues == 0:
            ...
            print(f"⚠️  {total_issues} security issues detected")
        print()
        ...
        for tool_name, scan_data in report['scans'].items():
            ...
            print(f"   {status_icon} {tool_name.title()}: {status}")
        ...
        if total_issues > 0:
            ...
            if summary['outdated_packages'] > 0:
                print("   3. Update outdated packages, especially security-sensitive ones")
...
def main():
    ...
    critical_issues = report['summary']['total_vulnerabilities'] + report['summary']['high_severity']
