...
from progress_indicators import workflow_progress, spinner, progress_bar, StatusTracker
        ...
        for step_num, (step_name, step_desc) in enumerate(steps, 1):
            ...
            if step_num == 1:
                ...
                for i, section in enumerate(sections, 1):
                    wp.update_step_progress(f"Generating {section} ({i}/{len(sections)})")
                    time.sleep(0.5)
...
def demo_nested_with_sub_progress():
    ...
    with workflow_progress(3, "Build & Deploy") as wp:
        ...
        tests = ["test_auth", "test_api", "test_models", "test_utils", "test_integration"]
...
if __name__ == "__main__":
    ...
    print("✓ Demo complete - This shows how nested progress would work in the workflow!")
