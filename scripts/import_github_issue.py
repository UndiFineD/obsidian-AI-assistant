...
"""
    ...
    parser.add_argument(
        '--owner',
        help='Repository owner (required if using issue number)'
    )
    parser.add_argument(
        '--repo',
        help='Repository name (required if using issue number)'
    )
    parser.add_argument(
        '--id',
        dest='change_id',
    ...
    parser.add_argument(
        '--owner-name',
        dest='owner_name',
        help='Change owner (default: issue author)'
    )
    parser.add_argument(
        '--base-dir',
        type=Path,
    ...
    try:
        ...
        owner, repo, issue_number = parse_issue_url(
            args.issue,
            args.owner,
            args.repo
        )
        ...
        print(f"  2. Follow OpenSpec workflow stages 0-12")
        print(f"  3. See openspec/PROJECT_WORKFLOW.md for details")
