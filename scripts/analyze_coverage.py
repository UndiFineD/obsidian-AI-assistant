...
<body>
    ...
    <div class="metric {
        ...
        <p>Target: 85% | Status: {
        "✅ Meets Target" if overall_coverage >= 85 else "⚠️ Below Target"
    }</p>
    </div>
    ...
    '''
        ...
        if opportunities
        else "<p>No improvements needed - all files meet target!</p>"
    }
    ...
    <hr>
    <p><small>Generated by coverage analysis script | Target: 85% | Current: {
        overall_coverage:.1f}%</small></p>
</body>
</html>
"""
    return html
