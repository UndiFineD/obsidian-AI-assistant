...
class TestEmbeddingsManager:
    """Test suite for the EmbeddingsManager class."""
    ...
    @pytest.fixture
    def embeddings_manager(self, temp_db_path, mock_sentence_transformer, mock_chroma_client):
    ...
    def test_embeddings_manager_initialization(self, temp_db_path, mock_sentence_transformer, mock_chroma_client):
    ...
    def test_default_initialization(self, mock_sentence_transformer, mock_chroma_client):
