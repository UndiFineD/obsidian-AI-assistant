...
def mock_all_services():
    ...
    with patch("backend.backend.model_manager", mock_model_manager), patch(
        "backend.backend.cache_manager", mock_cache_manager
    ), patch("backend.backend.embeddings_manager", mock_embeddings_manager), patch(
        "backend.backend.vault_indexer", mock_vault_indexer
    ):
