"""
Performance Regression Tests for Obsidian AI Agent
...
class TestPerformanceTrends:
    ...
    def test_response_time_consistency(self, performance_client):
        ...
        # Warmup: Make 3 initial requests to stabilize (GC, cache initialization, etc.)
        for _ in range(3):
            performance_client.get("/status")

        durations = []

        # Make 10 requests to the same endpoint (after warmup)
        for _ in range(10):
        ...
        # Max should not be more than 4x the average (consistency check)
