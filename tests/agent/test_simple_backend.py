...
from agent.simple_backend import app
...
class TestSimpleBackendEndpoints:
    ...
    def test_root_endpoint(self, client):
        ...
        assert data["message"] == "Obsidian AI Agent Backend is running"
    ...
    def test_status_endpoint(self, client):
        ...
        assert data["agent_url"] == "http://127.0.0.1:8000"
...
class TestSimpleBackendAppMetadata:
    ...
    def test_app_title(self):
        ...
        assert app.title == "Obsidian AI Agent - Simple Backend"
