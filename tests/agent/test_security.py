...
from agent.security import KEY, decrypt_data, encrypt_data, fernet
...
class TestSecurity:
    ...
    def test_key_consistency(self):
        ...
        from agent.security import KEY as imported_key
...
class TestSecurityIntegration:
    ...
    def test_security_module_constants_immutable(self):
        ...
        from agent.security import KEY as key_check
        from agent.security import fernet as fernet_check
