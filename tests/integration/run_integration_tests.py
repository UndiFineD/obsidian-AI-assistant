...
class IntegrationTestRunner:
    ...
    def run_test_file(self, test_file: Path) -> Tuple[bool, Dict]:
        ...
        pytest_args = [str(test_file), "-v", "--tb=short", "--no-header", "--quiet"]
        ...
        results = {"success": success, "duration": duration, "pytest_code": result_code}
    ...
    def run_all_integration_tests(self) -> bool:
        ...
        for test_file in test_files:
            self.results[test_file.name] = {
                ...
                "duration": total_duration / len(test_files),
            }
