# tests/obsidian-ai-agent/test_plugin_functionality.py
"""
...
class TestPluginFunctionality:
    ...
    def test_agent_health_check_functionality(self):
    ...
    def test_fetch_api_usage(self):
        ...
        found_json = sum(1 for pattern in json_patterns if re.search(pattern, content))
...
class TestTaskQueueFunctionality:
    ...
    def task_queue_content(self):
        task_queue_path = Path(".obsidian/plugins/obsidian-ai-agent/taskQueue.js")
...
class TestVoiceFunctionality:
    ...
    def voice_content(self):
        voice_path = Path(".obsidian/plugins/obsidian-ai-agent/voice.js")
        with open(voice_path, "r", encoding="utf-8") as f:
            return f.read()

    @property
    def voice_input_content(self):
        voice_input_path = Path(".obsidian/plugins/obsidian-ai-agent/voiceInput.js")
...
class TestAnalyticsFunctionality:
    ...
    def analytics_content(self):
        analytics_path = Path(".obsidian/plugins/obsidian-ai-agent/analyticsPane.js")
