# tests/obsidian-ai-assistant/test_plugin_structure.py
"""
...
class TestMainPluginFile:
    ...
    def main_js_content(self):
        main_path = Path(".obsidian/plugins/obsidian-ai-assistant/main.js")
        with open(main_path, "r", encoding="utf-8") as f:
            return f.read()
    ...
    def test_plugin_class_structure(self):
        ...
        assert (
            "class ObsidianAIAssistant extends Plugin" in content
...
class TestPluginModules:
    ...
    def test_voice_modules_structure(self):
        ...
        for filename in voice_files:
            file_path = Path(f".obsidian/plugins/obsidian-ai-assistant/{filename}")
