# tests/obsidian-ai-assistant/test_plugin_functionality.py
"""
...
class TestPluginFunctionality:
    ...
    @property
    def plugin_dir(self):
        return Path(".obsidian/plugins/obsidian-ai-assistant")
...
class TestTaskQueueFunctionality:
    ...
    def task_queue_content(self):
        task_queue_path = Path(".obsidian/plugins/obsidian-ai-assistant/taskQueue.js")
...
class TestVoiceFunctionality:
    ...
    def voice_input_content(self):
        voice_input_path = Path(".obsidian/plugins/obsidian-ai-assistant/voiceInput.js")
