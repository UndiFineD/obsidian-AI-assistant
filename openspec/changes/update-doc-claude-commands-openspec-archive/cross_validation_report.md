# Cross-Validation Report for update-doc-claude-commands-openspec-archive
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `.claude/commands/openspec/archive.md` under the `project-documentation` capability.'
