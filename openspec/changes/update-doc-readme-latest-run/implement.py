...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for update-doc-readme-latest-run")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: update-doc-readme-latest-run")
    print("=" * 50)
    print()
