# Cross-Validation Report for 2025-10-14-update-doc-docs-performance-requirements-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/PERFORMANCE_REQUIREMENTS_SPECIFICATION.md` under the `project-documentation` capability.'
