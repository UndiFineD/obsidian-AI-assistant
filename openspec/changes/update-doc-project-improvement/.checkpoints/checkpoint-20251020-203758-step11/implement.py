...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for update-doc-project-improvement")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: update-doc-project-improvement")
    print("=" * 50)
    print()
