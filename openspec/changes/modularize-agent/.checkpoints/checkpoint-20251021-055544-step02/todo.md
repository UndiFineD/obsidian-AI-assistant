...
- [ ] `openspec/changes/modularize-agent/todo.md` (this file)
- [ ] `openspec/changes/modularize-agent/proposal.md`
- [ ] `openspec/changes/modularize-agent/spec.md`
- [ ] `openspec/changes/modularize-agent/tasks.md`
- [ ] `openspec/changes/modularize-agent/test_plan.md`
- [ ] `openspec/changes/modularize-agent/retrospective.md`
- [ ] Test files in `tests/`
