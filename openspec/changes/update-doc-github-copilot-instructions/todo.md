...
## Change Information
- **Change ID**: `update-doc-github-copilot-instructions`
- **Created**: 2025-10-18
- **Owner**: 
- **Status**: In Progress
...
- [ ] `openspec/changes/update-doc-github-copilot-instructions/todo.md` (this file)
- [ ] `openspec/changes/update-doc-github-copilot-instructions/proposal.md`
- [ ] `openspec/changes/update-doc-github-copilot-instructions/spec.md`
- [ ] `openspec/changes/update-doc-github-copilot-instructions/tasks.md`
- [ ] `openspec/changes/update-doc-github-copilot-instructions/test_plan.md`
- [ ] `openspec/changes/update-doc-github-copilot-instructions/retrospective.md`
- [ ] Test files in `tests/`
