# Cross-Validation Report for 2025-10-14-update-doc-docs-project-constitution
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/PROJECT_CONSTITUTION.md` under the `project-documentation` capability.'
