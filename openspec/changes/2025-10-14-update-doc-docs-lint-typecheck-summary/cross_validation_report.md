# Cross-Validation Report for 2025-10-14-update-doc-docs-lint-typecheck-summary
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/LINT_TYPECHECK_SUMMARY.md` under the `project-documentation` capability.'
