...
- [ ] `openspec/changes/test-bugfix/todo.md` (this file)
- [ ] `openspec/changes/test-bugfix/proposal.md`
- [ ] `openspec/changes/test-bugfix/spec.md`
- [ ] `openspec/changes/test-bugfix/tasks.md`
- [ ] `openspec/changes/test-bugfix/test_plan.md`
- [ ] `openspec/changes/test-bugfix/retrospective.md`
- [ ] Test files in `tests/`
