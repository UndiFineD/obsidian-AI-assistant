# Cross-Validation Report for 2025-10-14-update-doc-docs-deployment-status
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/DEPLOYMENT_STATUS.md` under the `project-documentation` capability.'
