...
- [ ] `openspec/changes/update-doc-readme/todo.md` (this file)
- [ ] `openspec/changes/update-doc-readme/proposal.md`
- [ ] `openspec/changes/update-doc-readme/spec.md`
- [ ] `openspec/changes/update-doc-readme/tasks.md`
- [ ] `openspec/changes/update-doc-readme/test_plan.md`
- [ ] `openspec/changes/update-doc-readme/retrospective.md`
- [ ] Test files in `tests/`
