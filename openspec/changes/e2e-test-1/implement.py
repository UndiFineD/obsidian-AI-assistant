...
def main() -> int:
    ...
    global args
    parser = argparse.ArgumentParser(description="Implementation script for e2e-test-1")
    parser.add_argument("--what-if", action="store_true")
    parser.add_argument("--force", action="store_true")
    args = parser.parse_args()

    print("=" * 50)
    print(f"Implementation: e2e-test-1")
    print("=" * 50 + "\n")
