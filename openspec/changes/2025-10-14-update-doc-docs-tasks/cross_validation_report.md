# Cross-Validation Report for 2025-10-14-update-doc-docs-tasks
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/TASKS.md` under the `project-documentation` capability.'
