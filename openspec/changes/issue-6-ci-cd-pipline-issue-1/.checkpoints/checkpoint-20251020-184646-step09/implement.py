...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for issue-6-ci-cd-pipline-issue-1")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: issue-6-ci-cd-pipline-issue-1")
    print("=" * 50)
    print()
