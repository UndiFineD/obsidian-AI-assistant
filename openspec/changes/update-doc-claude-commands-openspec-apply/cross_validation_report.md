# Cross-Validation Report for update-doc-claude-commands-openspec-apply
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `.claude/commands/openspec/apply.md` under the `project-documentation` capability.'
