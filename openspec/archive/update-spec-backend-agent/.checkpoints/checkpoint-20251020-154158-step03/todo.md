# TODO: Update Spec Backend Agent
...
- [ ] `openspec/changes/update-spec-backend-agent/todo.md` (this file)
- [ ] `openspec/changes/update-spec-backend-agent/proposal.md`
- [ ] `openspec/changes/update-spec-backend-agent/spec.md`
- [ ] `openspec/changes/update-spec-backend-agent/tasks.md`
- [ ] `openspec/changes/update-spec-backend-agent/test_plan.md`
- [ ] `openspec/changes/update-spec-backend-agent/retrospective.md`
- [ ] Test files in `tests/`
