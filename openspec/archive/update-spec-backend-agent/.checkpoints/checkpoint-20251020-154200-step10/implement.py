...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for update-spec-backend-agent")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: update-spec-backend-agent")
    print("=" * 50)
    print()
