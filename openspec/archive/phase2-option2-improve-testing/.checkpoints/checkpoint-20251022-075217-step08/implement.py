...
def main() -> int:
    ...
    global args
    parser = argparse.ArgumentParser(description="Implementation script for phase2-option2-improve-testing")
    parser.add_argument("--what-if", action="store_true")
    parser.add_argument("--force", action="store_true")
    args = parser.parse_args()

    print("=" * 50)
    print(f"Implementation: phase2-option2-improve-testing")
    print("=" * 50 + "\n")
