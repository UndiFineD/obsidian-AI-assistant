# Cross-Validation Report for 2025-10-14-update-doc-docs-system-architecture-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SYSTEM_ARCHITECTURE_SPECIFICATION.md` under the `project-documentation` capability.'
