...
- [ ] `openspec/changes/test-review/todo.md` (this file)
- [ ] `openspec/changes/test-review/proposal.md`
- [ ] `openspec/changes/test-review/spec.md`
- [ ] `openspec/changes/test-review/tasks.md`
- [ ] `openspec/changes/test-review/test_plan.md`
- [ ] `openspec/changes/test-review/retrospective.md`
- [ ] Test files in `tests/`
