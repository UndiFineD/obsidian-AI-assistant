# Cross-Validation Report for 2025-10-18-update-doc-docs-constitution
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/CONSTITUTION.md` under the `project-documentation` capability.'
