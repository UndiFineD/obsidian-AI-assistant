# Cross-Validation Report for 2025-10-14-update-doc-docs-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SPECIFICATION.md` under the `project-documentation` capability.'
