...
- [ ] `openspec/changes/verify-phase3/todo.md` (this file)
- [ ] `openspec/changes/verify-phase3/proposal.md`
- [ ] `openspec/changes/verify-phase3/spec.md`
- [ ] `openspec/changes/verify-phase3/tasks.md`
- [ ] `openspec/changes/verify-phase3/test_plan.md`
- [ ] `openspec/changes/verify-phase3/retrospective.md`
- [ ] Test files in `tests/`
