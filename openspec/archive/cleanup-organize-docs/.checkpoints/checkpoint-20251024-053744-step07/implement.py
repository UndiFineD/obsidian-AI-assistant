...
def create_structure():
    try:
        ...
        # Create comprehensive README if it doesn't exist or is too small
        readme_path = docs / "README.md"
        if not readme_path.exists() or readme_path.stat().st_size < 500:
            readme_content = """# Obsidian AI Assistant - Documentation

Welcome to the Obsidian AI Assistant documentation! This directory contains comprehensive guides, architecture documentation, and reference materials for the project.

## 📚 Documentation Structure

### [Getting Started](./getting-started/)
Start here! Find introductions, quick-start guides, and overview documentation.

### [Guides](./guides/)
How-to guides, walkthroughs, and procedural documentation.

### [Architecture](./architecture/)
Technical architecture, system design, and API documentation.

### [Reference](./reference/)
Technical reference materials, specifications, and detailed documentation.

### [Production](./production/)
Production deployment, monitoring, and operational guides.

### [Historical](./historical/)
Archive of older documentation and previous project phases.

## 🚀 Getting Started

1. Start with [Getting Started Guide](./getting-started/)
2. Work through the [Guides](./guides/)
3. Reference the [Architecture docs](./architecture/)
