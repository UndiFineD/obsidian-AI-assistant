...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for test-step6")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: test-step6")
    print("=" * 50)
    print()
    ...
    invoke_task(
        "Verify File: frontend/app.js",
        lambda: verify_file(project_root / "frontend/app.js"),
        "Check that affected file exists"
    )
