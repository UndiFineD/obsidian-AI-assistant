# Cross-Validation Report for 2025-10-14-update-doc-docs-specification-summary
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SPECIFICATION_SUMMARY.md` under the `project-documentation` capability.'
