...
- [ ] `openspec/changes/modular-api-structure/todo.md` (this file)
- [ ] `openspec/changes/modular-api-structure/proposal.md`
- [ ] `openspec/changes/modular-api-structure/spec.md`
- [ ] `openspec/changes/modular-api-structure/tasks.md`
- [ ] `openspec/changes/modular-api-structure/test_plan.md`
- [ ] `openspec/changes/modular-api-structure/retrospective.md`
- [ ] Test files in `tests/`
