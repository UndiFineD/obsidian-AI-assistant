# Cross-Validation Report for 2025-10-14-update-doc-docs-setup-readme
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SETUP_README.md` under the `project-documentation` capability.'
