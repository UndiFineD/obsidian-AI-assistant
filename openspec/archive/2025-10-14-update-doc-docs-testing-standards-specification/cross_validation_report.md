# Cross-Validation Report for 2025-10-14-update-doc-docs-testing-standards-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/TESTING_STANDARDS_SPECIFICATION.md` under the `project-documentation` capability.'
