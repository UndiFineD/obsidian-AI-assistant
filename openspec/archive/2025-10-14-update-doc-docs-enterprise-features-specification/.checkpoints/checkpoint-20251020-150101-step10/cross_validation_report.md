# Cross-Validation Report for 2025-10-14-update-doc-docs-enterprise-features-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/ENTERPRISE_FEATURES_SPECIFICATION.md` under the `project-documentation` capability.'
