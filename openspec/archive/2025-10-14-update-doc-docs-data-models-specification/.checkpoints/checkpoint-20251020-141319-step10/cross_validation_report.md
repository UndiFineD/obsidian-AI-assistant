# Cross-Validation Report for 2025-10-14-update-doc-docs-data-models-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/DATA_MODELS_SPECIFICATION.md` under the `project-documentation` capability.'
