# Cross-Validation Report for 2025-10-14-update-doc-docs-spec
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/spec.md` under the `project-documentation` capability.'
