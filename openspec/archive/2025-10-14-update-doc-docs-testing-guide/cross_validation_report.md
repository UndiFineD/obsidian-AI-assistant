# Cross-Validation Report for 2025-10-14-update-doc-docs-testing-guide
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/TESTING_GUIDE.md` under the `project-documentation` capability.'
