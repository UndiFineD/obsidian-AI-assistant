# Cross-Validation Report for 2025-10-14-update-doc-docs-code-quality-improvements
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/CODE_QUALITY_IMPROVEMENTS.md` under the `project-documentation` capability.'
