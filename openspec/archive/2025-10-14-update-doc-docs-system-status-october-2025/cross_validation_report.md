# Cross-Validation Report for 2025-10-14-update-doc-docs-system-status-october-2025
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SYSTEM_STATUS_OCTOBER_2025.md` under the `project-documentation` capability.'
