...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for 2025-10-18-backlog-tool-ascii-burndown")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: 2025-10-18-backlog-tool-ascii-burndown")
    print("=" * 50)
    print()
