# Cross-Validation Report for 2025-10-14-update-doc-docs-plugin-integration-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/PLUGIN_INTEGRATION_SPECIFICATION.md` under the `project-documentation` capability.'
