...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for test-step6-progress")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: test-step6-progress")
    print("=" * 50)
    print()
    ...
    invoke_task(
        "Verify File: test.py",
        lambda: verify_file(project_root / "test.py"),
        "Check that affected file exists"
    )
    invoke_task(
        "Verify File: app.js",
        lambda: verify_file(project_root / "app.js"),
        "Check that affected file exists"
    )
