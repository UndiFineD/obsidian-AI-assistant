# Cross-Validation Report for 2025-10-14-update-doc-docs-security-specification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/SECURITY_SPECIFICATION.md` under the `project-documentation` capability.'
