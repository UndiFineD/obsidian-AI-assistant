...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for test-change")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: test-change")
    print("=" * 50)
    print()
    ...
    invoke_task(
        "Verify File: none",
        lambda: verify_file(project_root / "none"),
