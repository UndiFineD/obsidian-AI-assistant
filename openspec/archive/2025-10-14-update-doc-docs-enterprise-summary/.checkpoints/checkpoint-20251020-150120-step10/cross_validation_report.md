# Cross-Validation Report for 2025-10-14-update-doc-docs-enterprise-summary
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/ENTERPRISE_SUMMARY.md` under the `project-documentation` capability.'
