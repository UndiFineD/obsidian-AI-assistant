# Cross-Validation Report for 2025-10-14-update-doc-openspec-project
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `openspec/project.md` under the `project-documentation` capability.'
