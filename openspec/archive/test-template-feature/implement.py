...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for test-template-feature")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: test-template-feature")
    print("=" * 50)
    print()
