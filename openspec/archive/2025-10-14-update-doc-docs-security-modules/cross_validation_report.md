# Cross-Validation Report for 2025-10-14-update-doc-docs-security-modules
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/security-modules.md` under the `project-documentation` capability.'
