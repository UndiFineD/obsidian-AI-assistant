# Cross-Validation Report for 2025-10-14-update-doc-docs-quick-fix
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/QUICK_FIX.md` under the `project-documentation` capability.'
