# TODO: Reorganize Models Directory
...
- [ ] `openspec/changes/reorganize-models-directory/todo.md` (this file)
- [ ] `openspec/changes/reorganize-models-directory/proposal.md`
- [ ] `openspec/changes/reorganize-models-directory/spec.md`
- [ ] `openspec/changes/reorganize-models-directory/tasks.md`
- [ ] `openspec/changes/reorganize-models-directory/test_plan.md`
- [ ] `openspec/changes/reorganize-models-directory/retrospective.md`
- [ ] Test files in `tests/`
