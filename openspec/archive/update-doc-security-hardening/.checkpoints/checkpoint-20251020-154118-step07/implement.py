...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for update-doc-security-hardening")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: update-doc-security-hardening")
    print("=" * 50)
    print()
