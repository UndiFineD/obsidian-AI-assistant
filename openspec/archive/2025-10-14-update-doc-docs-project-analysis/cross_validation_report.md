# Cross-Validation Report for 2025-10-14-update-doc-docs-project-analysis
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/PROJECT_ANALYSIS.md` under the `project-documentation` capability.'
