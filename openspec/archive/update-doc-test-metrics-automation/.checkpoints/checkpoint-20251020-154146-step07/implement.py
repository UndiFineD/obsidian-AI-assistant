...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Implementation script for update-doc-test-metrics-automation")
    parser.add_argument(
        "--what-if",
        action="store_true",
    ...
    print("=" * 50)
    print(f"Implementation: update-doc-test-metrics-automation")
    print("=" * 50)
    print()
