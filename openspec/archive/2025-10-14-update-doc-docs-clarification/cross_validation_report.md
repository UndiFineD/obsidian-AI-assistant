# Cross-Validation Report for 2025-10-14-update-doc-docs-clarification
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/CLARIFICATION.md` under the `project-documentation` capability.'
