# Cross-Validation Report for 2025-10-14-update-doc-docs-integration-tests-completion-summary
...
-   → Missing in tasks.md: 'Add a documentation governance requirement for `docs/INTEGRATION_TESTS_COMPLETION_SUMMARY.md` under the `project-documentation` capability.'
