"""
Cache Management API Endpoints for Obsidian AI Agent
...
try:
    from agent.enhanced_caching import (
        CacheStrategy,
        CacheType,
        get_unified_cache_manager,
    )
    from agent.error_handling import SystemError, ValidationError, error_context
    from agent.security import require_role
except ImportError:
