...
exports.AnalyticsView = exports.VIEW_TYPE_ANALYTICS = void 0;
const obsidian_1 = require("obsidian");
// --- Constants ---
exports.VIEW_TYPE_ANALYTICS = "AI-analytics";
// --- Analytics View ---
class AnalyticsView extends obsidian_1.ItemView {
    constructor(leaf, state) {
        super(leaf);
        this.state = state;
    }
    getViewType() {
        return exports.VIEW_TYPE_ANALYTICS;
    }
    getDisplayText() {
