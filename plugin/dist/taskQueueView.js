...
exports.TaskQueueView = void 0;
const obsidian_1 = require("obsidian");
const taskQueue_1 = require("./taskQueue");
class TaskQueueView extends obsidian_1.ItemView {
    constructor(leaf, taskQueue) {
        super(leaf);
        this.taskQueue = taskQueue;
    }
    getViewType() {
        return taskQueue_1.VIEW_TYPE_TASK_QUEUE;
    }
    getDisplayText() {
        return "Task Queue";
    }
    ...
    removeTask(taskId) {
        ...
        if (index !== -1) {
            ...
            new obsidian_1.Notice("Task removed");
            this.renderTasks();
        }
    }
}
exports.TaskQueueView = TaskQueueView;
